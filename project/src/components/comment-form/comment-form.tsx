...
export default function CommentForm(): JSX.Element {
  ...
  return(
    <form className="reviews__form form" action="#" method="post">
      ...
      <textarea className="reviews__textarea form__textarea" onChange={fieldChangeHandle} id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" defaultValue={''} />
